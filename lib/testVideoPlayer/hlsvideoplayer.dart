...
class HLSVideoPlayerState extends State<HLSVideoPlayer> {
  final Color controlColor = Colors.white;
  ...
  void startTimer() {
    ...
    widget.controller.timer = new Timer.periodic(
      ...
      (Timer timer) => setState(() {
        ...
        // }
        this.setState(() {
          widget.controller.currentVideoPosition = widget
  ...
  String getTimeString(double second) {
    ...
    String returnValue = "";
    if (hours > 0) returnValue += sprintf("%02i:", [hours]);
  ...
  Widget getDropdownWidgets(
      List items, String suffix, bool isShow, Function onPressItem) {
  ...
  void onPressQualityBtn() {
    stopOneshotTimer();
    setState(() {
      widget.controller.isShowQualityList =
          !widget.controller.isShowQualityList;
    });
  }
  ...
  void onSetQuality(String quality) {
    ...
    setState(() async {
      ...
      widget.controller.isShowQualityList = false;
      widget.controller.videoController.pause();
      widget.playList[oldIndex].videoController =
      ...
      if (curPlayItem.videoController != null) {
        ...
        widget.controller.videoController =
            VideoPlayerController.network(curPlayItem.videoUri);
      ...
      await widget.controller.videoController
          .seekTo(Duration(seconds: curPosition.toInt()));
     // await widget.controller.videoController
        //  .setSpeed(widget.controller.videoSpeed);
      startOneshotTimer();
    });
  }
  ...
  void seekVideo(int seconds) {
    widget.controller.videoController.seekTo(
    ...
    return Align(
      ...
      child: Column(
       ...
       /*     MaterialButton(
              ...
              child: Text(
                widget.controller.videoSpeed.toString() + " X",
                style: TextStyle(
                  color: controlColor,
                ),
              ),
        ...
        /*  Row(children: <Widget>[
            ...
            getDropdownWidgets(widget.controller.videoSpeeds, " X",
                widget.controller.isShowSpeedList, onSetSpeed),
            getDropdownWidgets(widget.controller.videoQualities, "P",
                widget.controller.isShowQualityList, onSetQuality)
          ])*/
        ],
      ),
    );
  ...
  getVideoQualityString() {
    String quality =
        widget.controller.videoQualities[widget.controller.curPlaylistIndex];
    ...
    return Container(
      ...
      child: Center(
        ...
        children: <Widget>[
          ...
          IconButton(
            padding: EdgeInsets.all(0),
            icon: Icon(widget.controller.videoController.value.isPlaying
                ? Icons.pause
                : Icons.play_arrow),
            color: Colors.white,
            iconSize: buttonHeight,
      ...
      child: Align(
          ...
          child: Row(
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  ...
                  child: Slider(
                      ...
                      min: 0.0,
                      max: widget.controller.videoController.value.initialized
              ...
              Text(
                getTimeString(widget
                        .controller.videoController.value.initialized
                    ? widget.controller.videoController.value.duration.inSeconds
                        .toDouble()
                    : 0),
                style: TextStyle(
                  color: controlColor,
        ...
        child: Stack(children: [
          ...
          GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                duration: Duration(milliseconds: 500),
                curve: Curves.fastOutSlowIn,
                child: widget.controller.videoController.value.isBuffering
                    ? Center(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: HLSVideoPlayer(
            controller: widget.controller, isFullScreenScreen: true),
      ),
    );
  }
